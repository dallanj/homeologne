...
<div class="p-6">
                    ...
                    <table class="w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Privacy</th>
    ...
    <x-jet-dialog-modal wire:submit.prevent="submit" enctype="multipart/form-data" wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-jet-label for="filePrivacy" value="{{ __('Privacy') }}" />
                <select wire:model="filePrivacy" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
